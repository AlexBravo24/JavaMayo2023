...
por cuestiones de logística y seguridad. Realiza un algoritmo para determinar el cobro por la entrega 
de un paquete o, en su caso, el rechazo de la entrega.*/
		Scanner entrada = new Scanner(System.in);
	    int peso;
	    int zona;
	// Solicitud de datos al usuario
	    System.out.println("SE MUESTRA LA TARIFA PARA EL ENVIO DE PAQUETES");
	    ...
	    System.out.println("Introduce el numero de zona para envio:");
