...
public class Ejercicio7_EAGG {
	...
	public static void main(String[] args) {
		...
		// pagar a la compañía de viajes por el servicio. 
		...
		System.out.println("Introduce el número de alumnos que van a viajar:");
		...
		if (alumnos >= 100) {
			...
			System.out.println("El pago total a compañía es de: " + (precio*alumnos));
			...
			System.out.println("El pago total a compañía es de: " + precio);
		}
