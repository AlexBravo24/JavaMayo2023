...
public class Ejercicio11_AVG {

	public static void main(String[] args) {
		//  Una compañía de transporte internacional tiene servicio en 
		//algunos países de América del Norte, América Central, América del 
		//Sur, Europa y Asia. El costo por servicio de transporte se basa 
		//en el peso del paquete y la zona a la que va dirigida. 
